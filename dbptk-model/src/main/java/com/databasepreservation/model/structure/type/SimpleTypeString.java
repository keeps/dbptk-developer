...
public class SimpleTypeString extends Type {
         ...
         *
         * @param length         the maximum string length (required)
         * @param lengthVariable true if the string size can vary up to the maximum length,
         ...
         * @param lengthVariable true if the string size can vary up to the maximum length,
         *                       false if it fixed to length (required)
         * @param charset        the character repertoire used to create the string, e.g. UTF-8
         *                       (optional)
         */
