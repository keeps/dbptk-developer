...
public class ColumnStructure {
         ...
         *
         * @param id                the column unique id
         * @param name              the column name
         * @param nillable          if column values can be null
         * @param type              the column type
         * @param description       column description, optionally null
         * @param isGeneratedColumn
         * @param isAutoIncrement
         * @param defaultValue2
         */
        public ColumnStructure(String id, String name, Type type, Boolean nillable, String description,
        ...
        /**
         * @param description column description, null if none
         */
        ...
        /**
         * @param nillable true if values of this column can be null, false otherwise
         */
