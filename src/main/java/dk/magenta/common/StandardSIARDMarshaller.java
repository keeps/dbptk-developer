...
public class StandardSIARDMarshaller implements SIARDMarshaller {
	...
	@Override
	public void marshal(String contextStr,
			String localeSchemaLocation, String JAXBSchemaLocation,
