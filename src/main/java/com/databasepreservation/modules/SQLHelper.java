...
public class SQLHelper {
         ...
         * @throws UnknownTypeException
         */
        protected String createTypeSQL(Type type, boolean isPrimaryKey, boolean isForeignKey)
          throws UnknownTypeException {
                String ret;
        ...
        public String createPrimaryKeySQL(String tableId, PrimaryKey pkey) throws ModuleException {
                ...
                if (pkey != null) {
                        ...
                        if (StringUtils.isBlank(pkey.getName())) {
                                ...
                                ret.append(" ADD CONSTRAINT ").append(escapePrimaryKeyName(pkey.getName()))
                                  .append(" PRIMARY KEY (");
                        }
        ...
        public String createForeignKeySQL(TableStructure table, ForeignKey fkey) throws ModuleException {
                ...
                ret += ") REFERENCES " + escapeTableName(fkey.getReferencedSchema()) + "." + escapeTableName(
         ...
         * @param table          the table structure
         * @param row            the row
         * @param cellSQLHandler handler that will transform the cell in SQL
        ...
        protected String[] splitTableId(String tableId) throws ModuleException {
                ...
                if (parts.length < 2) {
                        throw new ModuleException(
                          "An error ocurred while spliting table id: " + "tableId is malformed");
                }
                return parts;
        }
        ...
        /**
         * @param database the database name required for some DBMSs
        ...
        public interface CellSQLHandler {
                 ...
                 * @param column the column to which this cell belongs to
