...
public class SIARDHelper {
        ...
        public static boolean isValidConstrainstCondition(String condition) {
                if (condition.equalsIgnoreCase("TRUE") || condition.equalsIgnoreCase("FALSE") || condition
        ...
        public static boolean isValidActionTime(String actionTime) {
                if (actionTime.equalsIgnoreCase("BEFORE") || actionTime.equalsIgnoreCase("AFTER") || actionTime
                  .equalsIgnoreCase("INSTEAD OF")) {
        ...
        public static boolean isValidTriggerEvent(String triggerEvent) {
                if (triggerEvent.equalsIgnoreCase("INSERT") || triggerEvent.equalsIgnoreCase("DELETE") || triggerEvent
