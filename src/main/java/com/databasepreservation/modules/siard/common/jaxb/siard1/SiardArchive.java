 ...
 * </pre>
 */
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "", propOrder = {"dbname", "description", "archiver",
  "archiverContact", "dataOwner", "dataOriginTimespan", "producerApplication", "archivalDate", "messageDigest",
  "clientMachine", "databaseProduct", "connection", "databaseUser", "schemas", "users", "roles",
  "privileges"}) @XmlRootElement(name = "siardArchive") public class SiardArchive {

        @XmlElement(required = true) protected String dbname;
        protected String description;
        protected String archiver;
        protected String archiverContact;
        @XmlElement(required = true) protected String dataOwner;
        @XmlElement(required = true) protected String dataOriginTimespan;
        protected String producerApplication;
        @XmlElement(required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "date") protected DateTime archivalDate;
        @XmlElement(required = true) protected String messageDigest;
        protected String clientMachine;
        protected String databaseProduct;
        protected String connection;
        protected String databaseUser;
        @XmlElement(required = true) protected SchemasType schemas;
        @XmlElement(required = true) protected UsersType users;
        protected RolesType roles;
        protected PrivilegesType privileges;
        @XmlAttribute(name = "version", required = true) protected String version;
