 ...
 * </pre>
 */
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "tablesType", propOrder = {"table"}) public class TablesType {

        @XmlElement(required = true) protected List<TableType> table;
