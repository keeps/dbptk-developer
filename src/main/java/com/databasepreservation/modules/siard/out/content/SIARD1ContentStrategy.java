 ...
 */
public class SIARD1ContentStrategy implements ContentStrategy {
	private final Logger logger = Logger.getLogger(SIARD1ContentStrategy.class);
	...
	public SIARD1ContentStrategy(PathStrategy pathStrategy, WriteStrategy writeStrategy, OutputContainer baseContainer) {
