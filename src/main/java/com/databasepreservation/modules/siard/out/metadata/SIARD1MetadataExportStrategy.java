...
import com.databasepreservation.modules.siard.common.jaxb.siard1.ActionTimeType;
...
import com.databasepreservation.modules.siard.common.jaxb.siard1.MatchTypeType;
...
import com.databasepreservation.modules.siard.common.jaxb.siard1.PrivOptionType;
...
public class SIARD1MetadataExportStrategy implements MetadataExportStrategy {
        ...
        @Override public void writeMetadataXML(DatabaseStructure dbStructure, SIARDArchiveContainer container,
          WriteStrategy writeStrategy) throws ModuleException {
                ...
                try {
                        xsdSchema = schemaFactory
                          .newSchema(Paths.get(getClass().getResource(METADATA_XSD_RESOURCE_PATH).getPath()).toFile());
                } catch (SAXException e) {
                        throw new ModuleException(
                          "XSD file has errors: " + getClass().getResource(METADATA_XSD_RESOURCE_PATH).getPath(), e);
                }
        ...
        @Override public void writeMetadataXSD(DatabaseStructure dbStructure, SIARDArchiveContainer container,
          WriteStrategy writeStrategy) throws ModuleException {
                // prepare to write
        ...
        private PrivilegeType jaxbPrivilegeType(PrivilegeStructure privilege) throws ModuleException {
                ...
                if (StringUtils.isNotEmpty(privilege.getType())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting users structure: privilege type cannot be blank");
                }
                ...
                if (StringUtils.isNotEmpty(privilege.getObject())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting users structure: privilege object cannot be blank");
                }
                ...
                if (StringUtils.isNotBlank(privilege.getGrantor())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting users structure: privilege grantor cannot be blank");
                }
                ...
                if (StringUtils.isNotBlank(privilege.getGrantee())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting users structure: privilege grantee cannot be blank");
                }
        ...
        private SchemaType jaxbSchemaType(SchemaStructure schema) throws ModuleException {
                ...
                if (StringUtils.isNotBlank(schema.getName())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting schema structure: schema name cannot be blank");
                }
        ...
        private ParameterType jaxbParameterType(Parameter parameter) throws ModuleException {
                ...
                if (StringUtils.isNotBlank(parameter.getName())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting routine parameters: parameter name cannot be blank");
                }
                ...
                if (StringUtils.isNotBlank(parameter.getMode())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting routine parameters: parameter mode cannot be blank");
                }
                ...
                if (parameter.getType() != null) {
                        ...
                        throw new ModuleException(
                          "Error while exporting routine parameters: parameter type cannot be null");
                }
        ...
        private TriggerType jaxbTriggerType(Trigger trigger) throws ModuleException {
                ...
                if (StringUtils.isNotBlank(trigger.getName())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting trigger: trigger name key name cannot be blank");
                }
                ...
                try {
                        ...
                        throw new ModuleException("Error while exporting trigger: trigger actionTime cannot be null",
                          e);
                }
                ...
                if (StringUtils.isNotBlank(trigger.getTriggerEvent())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting trigger: trigger triggerEvent cannot be blank");
                }
                ...
                if (StringUtils.isNotBlank(trigger.getTriggeredAction())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting trigger: trigger triggeredAction cannot be black");
                }
        ...
        private CheckConstraintsType jaxbCheckConstraintsType(List<CheckConstraint> checkConstraints)
        ...
        private CheckConstraintType jaxbCheckConstraintType(CheckConstraint checkConstraint) throws ModuleException {
                ...
                if (StringUtils.isNotBlank(checkConstraint.getName())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting check constraint: check constraint key name cannot be null");
                }
                ...
                if (StringUtils.isNotBlank(checkConstraint.getCondition())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting candidate key: check constraint condition cannot be null");
                }
        ...
        private CandidateKeyType jaxbCandidateKeyType(CandidateKey candidateKey) throws ModuleException {
                ...
                if (StringUtils.isNotBlank(candidateKey.getName())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting candidate key: candidate key name cannot be null");
                }
                ...
                if (candidateKey.getColumns() != null && candidateKey.getColumns().size() > 0) {
                        ...
                        throw new ModuleException(
                          "Error while exporting candidate key: columns cannot be be null or empty");
                }
        ...
        private ForeignKeyType jaxbForeignKeyType(ForeignKey foreignKey) throws ModuleException {
                ...
                if (StringUtils.isNotBlank(foreignKey.getReferencedSchema())) {
                        ...
                        throw new ModuleException(
                          "Error while exporting foreign key: referencedSchema cannot be blank");
                }
                ...
                if (foreignKey.getReferences() != null && foreignKey.getReferences().size() > 0) {
                        ...
                        throw new ModuleException(
                          "Error while exporting foreign key: reference cannot be null or empty");
                }
