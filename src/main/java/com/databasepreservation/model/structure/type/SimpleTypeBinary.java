...
public class SimpleTypeBinary extends Type {
         ...
         *
         * @param formatRegistryName a file format registry, like MIME or PRONOM
         * @param formatRegistryKey  the file format according to the designated registry, e.g.
         ...
         *
         * @param name the name of the registry, like MIME or PRONOM
         * @param key  the file format, like image/png for MIME
         */
