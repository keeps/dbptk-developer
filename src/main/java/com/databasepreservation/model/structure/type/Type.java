...
public abstract class Type {
        ...
        public void setOriginalTypeName(String originalTypeName, int originalColumnSize, int originalDecimalDigits) {
                this.originalTypeName = String
                  .format("%s(%d,%d)", originalTypeName, originalColumnSize, originalDecimalDigits);
        }
        ...
        /**
         * @param sql99TypeName the name of the original type, null if not applicable
         */
        ...
        /**
         * @param description the type description, null for none
         */
        ...
        @Override public boolean equals(Object o) {
                ...
                if (originalTypeName != null ?
                  !originalTypeName.equals(type.originalTypeName) :
                  type.originalTypeName != null)
                        return false;
                if (description != null ? !description.equals(type.description) : type.description != null)
                        return false;
                return !(sql99TypeName != null ?
                  !sql99TypeName.equals(type.sql99TypeName) :
                  type.sql99TypeName != null);
