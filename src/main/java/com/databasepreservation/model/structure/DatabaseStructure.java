...
public class DatabaseStructure {
         ...
         * @param creationDate                     date when the database was created, ISO 8601 format
         * @param productName                      the DBMS name
         * @param productVersion                   the DBMS version
         * @param defaultTransactionIsolationLevel database's default transaction isolation level
         * @param extraNameCharacters              "extra" characters that can be used in unquoted identifier
         *                                         names (those beyond a-z, A-Z, 0-9 and _)
         * @param stringFunctions                  comma-separated list of string functions available with this
         *                                         database
         * @param systemFunctions                  comma-separated list of system functions available with this
         *                                         database
         * @param timeDateFunctions                comma-separated list of the time and date functions available
         *                                         with this database
         * @param url                              URL for the DBMS
         * @param supportsANSI92EntryLevelSQL      whether this database supports the ANSI92 entry level SQL
         *                                         grammar
         * @param supportsANSI92IntermediateSQL    whether this database supports the ANSI92 intermediate SQL
         *                                         grammar
         * @param supportsANSI92FullSQL            whether this database supports the ANSI92 full SQL grammar
         * @param supportsCoreSQLGrammar           whether this database supports the ODBC Core SQL grammar
         */

        // TODO complete doc
        public DatabaseStructure(String name, String description, String archiver, String archiverContact,
          String dataOwner, String dataOriginTimespan, String producerApplication, DateTime archivalDate,
        ...
        /**
         * @param archivalDate the date when the database was archived
         */
        ...
        /**
         * @param schemas this database schemas
         */
        ...
        @Override public int hashCode() {
                ...
                result = prime * result + ((defaultTransactionIsolationLevel == null) ?
                  0 :
                ...
                result =
                  prime * result + ((supportsANSI92EntryLevelSQL == null) ? 0 : supportsANSI92EntryLevelSQL.hashCode());
                result = prime * result + ((supportsANSI92FullSQL == null) ? 0 : supportsANSI92FullSQL.hashCode());
                result = prime * result + ((supportsANSI92IntermediateSQL == null) ?
                  0 :
