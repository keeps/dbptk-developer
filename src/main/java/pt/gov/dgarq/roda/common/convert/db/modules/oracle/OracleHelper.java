package pt.gov.dgarq.roda.common.convert.db.modules.oracle;
...
public class OracleHelper extends SQLHelper {
	...
	public String getCheckConstraintsSQL(String schemaName, String tableName) {
		return "SELECT constraint_name AS CHECK_NAME, "
	...
	public String getTriggersSQL(String schemaName, String tableName) {
		return "SELECT TRIGGER_NAME, TRIGGER_TYPE AS ACTION_TIME, " 
				+ "TRIGGERING_EVENT AS TRIGGER_EVENT, "
				+ "TRIGGER_BODY AS TRIGGERED_ACTION "
				+ "FROM ALL_TRIGGERS "  
				+ "WHERE TABLE_NAME = '" + tableName + "'";
	}
