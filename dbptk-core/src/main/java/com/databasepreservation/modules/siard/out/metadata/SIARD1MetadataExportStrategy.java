...
public class SIARD1MetadataExportStrategy implements MetadataExportStrategy {
        ...
        @Override public void writeMetadataXML(DatabaseStructure dbStructure, SIARDArchiveContainer container,
          WriteStrategy writeStrategy) throws ModuleException {
                ...
                try {
                        xsdSchema = schemaFactory.newSchema(
                          new StreamSource(SiardArchive.class.getResourceAsStream(METADATA_XSD_RESOURCE_PATH)));
                } catch (SAXException e) {
                        throw new ModuleException(
                          "XSD file has errors: " + SiardArchive.class.getResource(METADATA_XSD_RESOURCE_PATH)
                            .getPath(), e);
                }
