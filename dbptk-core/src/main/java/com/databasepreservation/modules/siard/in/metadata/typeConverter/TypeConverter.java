...
/**
 * Classes implementing this interface should be able to convert a SQL
 * normalized type (sql-99, sql-2003, etc) to an internal type structure.
 *
...
public interface TypeConverter {
   ...
   *
   * @param sqlStandardType
   *          SQL normalized type (sql-99, sql-2003, etc)
   * @param originalType
