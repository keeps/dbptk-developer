  ...
  public void setup() throws IOException, InterruptedException, URISyntaxException {
    ...
    rt = new Roundtrip(
      ...
      new String[] {"migrate", "--import=mysql", "--import-hostname=127.0.0.1", "--import-database", db_source,
        "--import-username", db_tmp_username, "--import-password", db_tmp_password, "--export=siard-dk-2010",
        "--export-folder", archiveFullPath},

      new String[] {"migrate", "--import=siard-dk-2010", "--import-as-schema=dpttest", "--import-folder", archiveFullPath,
