...
public class TestingHelper {
  ...
  public static String[] getExportToSIARD1Command(String importModule, JdbcDatabaseContainer<?> container,
  ...
  public static String[] getImportFromSIARD1Command(String exportModule, JdbcDatabaseContainer<?> container,
    String siardPath) {
    List<String> command = new ArrayList<>();
    command.add("migrate");
