...
public class SIARDDKTestUtil {
  ...
  static void assertArchiveFoldersEqualAfterExportImport(Path archiveFldToProcessPath, Path archiveFldExpectedPath,
    ...
    String[] argumentsToMain = new String[] {"migrate", "--import=siard-dk-2010", "--import-as-schema=public", "--import-folder",
      archiveFldToProcessPath.toString(), "--export", "siard-dk-2010", "--export-folder",
