 ...
 */
public class SIARD22ContentExportStrategy implements ContentExportStrategy {
  private static final Logger LOGGER = LoggerFactory.getLogger(SIARD22ContentExportStrategy.class);
