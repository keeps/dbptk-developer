 ...
 *
 */
public class SIARDDK1007TableIndexFileStrategy implements IndexFileStrategy {
  ...
  private static final Logger logger = LoggerFactory.getLogger(SIARDDK1007TableIndexFileStrategy.class);
