...
import com.databasepreservation.modules.siard.validate.generic.component.metadata.MetadataRoleValidator;

/**
 * @author Gabriel Barros <gbarros@keep.pt>
 */
public class MetadataRoleComponentFactory implements ValidatorComponentFactory {
  private final String MODULE_NAME = Constants.COMPONENT_METADATA_ROLE;
  ...
  @Override
  public String next() {
    return Constants.COMPONENT_METADATA_PRIVILEGE;
  }

  @Override
  public ValidatorComponent buildComponent(Reporter reporter) throws ModuleException {
    return new MetadataRoleValidator(MODULE_NAME);
  }
}
