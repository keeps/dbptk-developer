 ...
 *
 */
public class SIARDDK2010FileIndexFileStrategy implements IndexFileStrategy {
  private static final Logger LOGGER = LoggerFactory.getLogger(SIARDDK2010FileIndexFileStrategy.class);
  ...
  public SIARDDK2010FileIndexFileStrategy() {
