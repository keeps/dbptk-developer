 ...
 */
public class SIARDDK1007FileIndexHandler extends SIARDDKFileIndexHandler {

  public SIARDDK1007FileIndexHandler(Map<String, String> archiveFolderLookupByFolderName,
