 ...
 *
 */
public class SIARDDK2010ModuleFactory implements DatabaseModuleFactory {
  ...
  public DatabaseFilterModule buildExportModule(Map<Parameter, String> parameters, Reporter reporter)
    ...
    return new SIARDDK2010ExportModule(exportModuleArgs).getDatabaseExportModule();
  }
}
