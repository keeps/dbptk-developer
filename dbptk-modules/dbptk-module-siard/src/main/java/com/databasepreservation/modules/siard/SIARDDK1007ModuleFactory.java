 ...
 *
 */
public class SIARDDK1007ModuleFactory implements DatabaseModuleFactory {
  ...
  public DatabaseImportModule buildImportModule(Map<Parameter, String> parameters, Reporter reporter) {
    ...
    return new SIARDDK1007ImportModule(Paths.get(parameters.get(folder)), parameters.get(importAsSchema))
  ...
  public DatabaseFilterModule buildExportModule(Map<Parameter, String> parameters, Reporter reporter)
    ...
    return new SIARDDK1007ExportModule(exportModuleArgs).getDatabaseExportModule();
  }
}
