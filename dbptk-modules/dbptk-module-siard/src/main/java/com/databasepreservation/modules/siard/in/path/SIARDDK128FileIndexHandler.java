 ...
 */
public class SIARDDK128FileIndexHandler extends SIARDDKFileIndexHandler {

  public SIARDDK128FileIndexHandler(Map<String, String> archiveFolderLookupByFolderName,
