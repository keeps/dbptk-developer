 ...
 */
public class SIARDDK2010EditFactory implements EditModuleFactory {
  ...
  public EditModule buildModule(Map<Parameter, String> parameters, Reporter reporter) throws ModuleException {
    ...
    return new SIARDEditModule(pFolder, SIARDConstants.SiardVersion.DK_2010);
  }
}
