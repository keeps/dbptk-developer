 ...
 *
 */
public class SIARDDK128ModuleFactory implements DatabaseModuleFactory {
  ...
  public DatabaseImportModule buildImportModule(Map<Parameter, String> parameters, Reporter reporter) {
    ...
    return new SIARDDK128ImportModule(Paths.get(parameters.get(folder)), parameters.get(importAsSchema))
  ...
  public DatabaseFilterModule buildExportModule(Map<Parameter, String> parameters, Reporter reporter)
    ...
    return new SIARDDK128ExportModule(exportModuleArgs).getDatabaseExportModule();
  }
}
