...
import com.databasepreservation.modules.siard.bindings.siard_dk_1007_ext.FileIndexType;
import com.databasepreservation.modules.siard.bindings.siard_dk_1007_ext.FileIndexType.F;
 ...
 */
public class SIARDDK1007ExtPathImportStrategy extends SIARDDKPathImportStrategy<F, FileIndexType> {
  protected final Logger logger = LoggerFactory.getLogger(ContentPathImportStrategy.class);

  public SIARDDK1007ExtPathImportStrategy(SIARDArchiveContainer mainFolder, ReadStrategy readStrategy,
