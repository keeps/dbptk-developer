...
import com.databasepreservation.modules.siard.validate.generic.component.metadata.MetadataTableValidator;

/**
 * @author Gabriel Barros <gbarros@keep.pt>
 */
public class MetadataTableComponentFactory implements ValidatorComponentFactory {
  private final String MODULE_NAME = Constants.COMPONENT_METADATA_TABLE;
  ...
  @Override
  public String next() {
    return Constants.COMPONENT_METADATA_COLUMN;
  }

  @Override
  public ValidatorComponent buildComponent(Reporter reporter) throws ModuleException {
    return new MetadataTableValidator(MODULE_NAME);
  }
}
