...
import com.databasepreservation.modules.siard.bindings.siard_dk_2020.TablesType;
import com.databasepreservation.modules.siard.bindings.siard_dk_2020.ViewType;
import com.databasepreservation.modules.siard.bindings.siard_dk_2020.ViewsType;
 ...
 *
 */
public class SIARDDK2020TableIndexFileStrategy implements IndexFileStrategy {

  // LOBsTracker used to get the locations of functionalDescriptions
  private LOBsTracker lobsTracker;
  private String regex;

  public SIARDDK2020TableIndexFileStrategy(LOBsTracker lobsTracker) {
    this.lobsTracker = lobsTracker;
    regex = "(\\p{L}(_|\\w)*)|(\".*\")";
  }

  private static final Logger logger = LoggerFactory.getLogger(SIARDDK2020TableIndexFileStrategy.class);
